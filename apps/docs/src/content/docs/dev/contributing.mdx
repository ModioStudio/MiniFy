---
title: Contributing
description: Complete guide to contributing to MiniFy - code, documentation, themes, and more.
---
...
Use the [bug report template](https://github.com/ModioStudio/MiniFy/issues/new?template=bug_report.md).
...
Use the [feature request template](https://github.com/ModioStudio/MiniFy/issues/new?template=feature_request.md).
...
[Code of Conduct](https://github.com/ModioStudio/MiniFy/blob/main/CODE_OF_CONDUCT.md).
...
By contributing to MiniFy, you agree that your contributions will be licensed under the
[MIT License](https://github.com/ModioStudio/MiniFy/blob/main/LICENSE).
