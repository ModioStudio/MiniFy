...
description: Complete overview of the MiniFy desktop application - features, architecture, and capabilities.
---
...
MiniFy is a desktop application built with [Tauri](https://tauri.app/) and [React](https://react.dev/).
